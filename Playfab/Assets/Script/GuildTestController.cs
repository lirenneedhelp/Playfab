    ...
    GameObject guildCreatePanel;
     // A local cache of some bits of PlayFab data
        ...
        public void CreateGroup()
        {
            ...
            var request = new CreateGroupRequest { GroupName = guildCreatePanel.transform.Find("GuildNameInput").GetComponent<TMP_InputField>().text, Entity = EntityKeyMaker(DataCarrier.Instance.entityId) };
